...
export function RoomsPage({ rooms, selectedRoomId, saving, onCreate, onSelect, onDelete, directoryUsers, teams, canManage, onAddMember, onInvite }: RoomsPageProps) {
  ...
  const [piLabel, setPiLabel] = useState('PI 1');
