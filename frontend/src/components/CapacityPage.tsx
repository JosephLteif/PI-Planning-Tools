...
function officeWorkdays(member: RoomState['capacity']['members'][number], sprint: CapacitySprint) {
...
function sprintCapacity(member: RoomState['capacity']['members'][number], sprint: CapacitySprint, defaults: RoomState['capacity']['defaults']) {
